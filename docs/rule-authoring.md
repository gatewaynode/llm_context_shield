...
|----------------|----------|---------|-------------------------------------------|---------------------------------------|
| `category`     | yes      | string  | `prompt_injection`, `jailbreak`, `data_exfiltration`, `hidden_content`, `delimiter_manipulation`, `instruction_override`, `refusal_suppression`, `response_steering`, `secret_probing`, `context_shift` | Finding category, severity filtering |
...
|---|---|
| `prompt_hijack` | `prompt_injection`, `instruction_override`, `response_steering`, `secret_probing` |
| `social_engineering` | `jailbreak`, `refusal_suppression`, `context_shift` |
