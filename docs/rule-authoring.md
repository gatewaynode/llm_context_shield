...
|----------------|----------|---------|-------------------------------------------|---------------------------------------|
| `category`     | yes      | string  | `prompt_injection`, `jailbreak`, `data_exfiltration`, `hidden_content`, `delimiter_manipulation`, `instruction_override`, `refusal_suppression`, `response_steering` | Finding category, severity filtering |
...
|---|---|
| `prompt_hijack` | `prompt_injection`, `instruction_override`, `response_steering` |
